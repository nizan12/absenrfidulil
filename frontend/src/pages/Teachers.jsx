                                ...
                                {teachers.length > 0 ? teachers.map((teacher) => (
                                    <tr key={teacher.id}>
                                        ...
                                        <td>
                                            <div className="flex items-center gap-3">
                                                {teacher.photo ? (
                                                    <img src={`${import.meta.env.VITE_API_URL?.replace('/api', '') || 'http://localhost:8000'}/storage/${teacher.photo}`} alt={teacher.name} className="w-10 h-10 rounded-full object-cover" />
                                                ) : (
